...
@Singleton
final class MinimalistNotesServlet extends HttpServlet {
  ...
  private static ImmutableMap<String, ImmutableList<ImmutableMap<String, String>>> listNotesByTag(ImmutableList<NotesDocument> notes) {
    ImmutableListMultimap<Optional<String>, NotesDocument> tagMap = Multimaps.index(notes, MinimalistNotesServlet::getFirstTag);
